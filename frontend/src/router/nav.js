...
export const paths = {
  ...
  userMetricsProjects: (userId) => `/users/${encodeURIComponent(userId)}/metrics/projects`,
  userMetricsProject: (userId, projectId) => `/users/${encodeURIComponent(userId)}/metrics/projects/${projectId}`,
  projects: () => '/',
